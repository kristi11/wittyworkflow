    ...
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200 dark:bg-gray-800">
        ...
        @can('is_admin')
            <p class="mt-6 text-gray-500 leading-relaxed dark:text-gray-200">
                This is the administrator's dashboard for {{ config('app.name', 'Witty Workflow')}}. Here you have administrative access to the system. You can view all the users in the system, change a user's role, view all the appointments in the system and much more.
            </p>
        @endcan

        @can('is_staff_member')
            <p class="mt-6 text-gray-500 leading-relaxed dark:text-gray-200">
                This is the staff member's dashboard for {{ config('app.name', 'Witty Workflow')}}. Staff members are limited only to managing the appointments. More functionality will be added in the future.
            </p>
        @endcan

        @can('is_user')
            <p class="mt-6 text-gray-500 leading-relaxed dark:text-gray-200">
                This is the customer's dashboard for {{ config('app.name', 'Witty Workflow')}}. Here you can manage your appointments, view detailed version of the services, and much more to be added in the future.
            </p>
        @endcan
