<div>
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <x-guest.guest-services-display :flexiblePricing="$flexiblePricing" :appointmentsVisibility="$appointmentsVisibility" :service="$service" :services="$services"/>
        </div>
    </section>
    <section class="bg-gray-100 py-8">
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            <x-guest.guest-hours-display :hours="$hours" :alwaysOpen="$alwaysOpen"/>
        </div>
    </section>
    <section class="bg-white border-b py-8">
