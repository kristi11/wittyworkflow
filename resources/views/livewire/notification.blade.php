<div>
    <div
        style="display: none"
         ...
         class="z-50 bg-white dark:bg-gray-700 border border-gray-200 fixed font-semibold mr-2 mt-2 p-6 right-0 rounded-lg shadow-xl text-gray-500 dark:text-gray-200 top-0 flex"
    >
        <div class="mr-2">
